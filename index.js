...
const r = yaml.load(fs.readFileSync(file, 'utf8'))
Parse(r, options.PrintRecipe, options.Verbose, options.TemplateVars)
...
// Create Rootdir
!fs.existsSync(context.Rootdir) && fs.mkdirSync(context.Rootdir, { mode: 0755 })
